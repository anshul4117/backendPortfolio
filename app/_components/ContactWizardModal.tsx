    ...
    useEffect(() => {
        ...
        switch (topic) {
            case 'hiring':
                ...
                break;
            case 'collaboration':
                template = `Hi Anshul,\n\nI'm ${name || 'there'}${companyStr}. I saw your projects like Dev Tinder and the blogging platform. I'm currently working on a backend system and would love to collaborate or exchange ideas with you on scalability and system design.\n\nLet me know if you'd be open to a chat!\n\nBest,\n${name || 'Best'}`;
                break;
            case 'tech_chat':
